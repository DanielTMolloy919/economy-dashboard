...
export async function fetchNzGdpPerCapita(): Promise<MetricData> {
  // NZLRGDPPCMEI: Real GDP per capita, chain volume index, quarterly SA (OECD MEI)
  const series = await fetchFredSeries("NZLRGDPPCMEI", "2004-01-01");
