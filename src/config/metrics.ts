...
const auMetricDefinitions: MetricDefinition[] = [
  ...
  },
  {
    ...
    frequency: "Quarterly",
    chartType: "bar",
    description: "Annual growth in GDP per hour worked — the standard measure of labour productivity",
    section: "Growth & Output",
    trendPolarity: "positive",
    decimals: 1,
    trendWindow: 4,
...
const usMetricDefinitions: MetricDefinition[] = [
  ...
  },
  {
    ...
    frequency: "Quarterly",
    chartType: "bar",
    description: "Annual growth in nonfarm business output per hour worked (BLS)",
    section: "Growth & Output",
    trendPolarity: "positive",
    decimals: 1,
    trendWindow: 4,
...
const ukMetricDefinitions: MetricDefinition[] = [
  ...
  },
  {
    ...
    frequency: "Quarterly",
    chartType: "bar",
    description: "Annual growth in whole-economy output per hour worked",
    section: "Growth & Output",
    trendPolarity: "positive",
    decimals: 1,
    trendWindow: 4,
